...
class Circle extends Shape {
    ...
    render() {
        return `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="100" r="70" fill="${this.shapeColor}" />${this.name(this.textColor, this.textABC)}</svg>`;
    }
}
...
class Triangle extends Shape {
    ...
    render() {
        return `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points="150 20, 70 180, 230 180" fill="${this.shapeColor}" />${this.name(this.textColor, this.textABC)}</svg>`;
    }
}
...
class Square extends Shape {
    ...
    render() {
        return `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect width="180" height="180" x="60" y="10" fill="${this.shapeColor}" />${this.name(this.textColor, this.textABC)}</svg>`;
    }
}
