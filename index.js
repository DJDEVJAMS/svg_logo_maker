...
// THEN I can enter a color keyword (OR a hexadecimal number)
    {
type: "input",
message: colors.brightblue("Enter a color keyword (ora hexadecimal number) for text color"),
name: "text_color",
           },
...
{
type: "input",
message: colors.brightblue ("Enter a color keyword (ora hexadecimal number) for shape color"),
name: "shape_color",
},
...
fs.writeFile('/examples/log.svg', readmeContent, (err) =>
    err ? console.error(err) : console.log('logo.svg created successfully!')
);
}};
}
